...
- |Efficiency| Removed the package dependency on graspy, now called `graspologic <https://microsoft.github.io/graspologic/latest/#>`_, since graspy is no longer being maintained. `#305 <https://github.com/mvlearn/mvlearn/pull/305>`_ by `Gavin Mischler`_.

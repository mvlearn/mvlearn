"""
vs Single-view Spectral Clustering
==================================
...
# performance, we run the algorithm on each view separately as well as all views
...
# best clustering results with respect to cluster inertia (within cluster sum-

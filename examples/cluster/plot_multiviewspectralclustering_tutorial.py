...
# separate the two views. As we can see below, multi-view spectral clustering is
# capable of effectively clustering non-convex cluster shapes, similarly to its
# single-view analog.

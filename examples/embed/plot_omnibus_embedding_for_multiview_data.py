...
# represent different information. Lines are drawn between corresponding samples
# in the two views.
...
# symbols denote which view each sample is from. We randomly plot 500 samples to
